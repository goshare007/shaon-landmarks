...
function FeaturedCard({ project }: { project: Project }) {
  return (
    <Link
      ...
      className='block'
    >
      <div className='relative min-h-[50vh] overflow-hidden rounded-sm md:min-h-[70vh]'>
...
function GridCard({ project }: { project: Project }) {
  return (
    ...
    >
      <div className='relative min-h-72 overflow-hidden rounded-sm md:min-h-80'>
        <div className='absolute inset-0'>
          <Image
            src={project.image}
            alt={project.title}
    ...
    <section className='bg-white py-20 md:py-28'>
      <div className='mx-auto max-w-360 px-4 md:px-16'>
        <div className='mb-12'>
          ...
          <div className='mt-6 h-px w-24 bg-secondary' />
        </div>
        ...
        <div className='mt-12 flex items-center gap-6'>
          <div className='hidden h-px w-16 bg-secondary md:block' />
          <Link
            to='/portfolio'
