	...
	return (
		<main>
			...
			<section className="relative overflow-hidden bg-tertiary">
				<div className="mx-auto grid min-h-[716px] max-w-[1440px] md:grid-cols-2">
					<motion.div
					...
					<motion.div
						className="relative h-[400px] overflow-hidden md:h-full"
				...
				<div className="mx-auto max-w-[1440px] px-4 md:px-16">
					<div className="grid gap-12 md:grid-cols-2">
						...
						>
							...
							<ul className="space-y-4 text-[11px] font-medium tracking-[0.1em] text-on-surface uppercase">
								{[
									"100% Timely Handover",
