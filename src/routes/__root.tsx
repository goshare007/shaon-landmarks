			...
			<main className="flex min-h-dvh items-center justify-center bg-surface px-4">
				<div className="mx-auto max-w-2xl py-20 text-center">
					...
					<div className="mt-10 flex items-center justify-center gap-4">
						<Link
							to="/"
							className="inline-flex items-center gap-2 rounded-sm bg-secondary px-8 py-3.5 text-[11px] font-medium tracking-[0.1em] text-on-secondary uppercase transition-all hover:opacity-90"
						>
							Back to Home
						</Link>
						<Link
							to="/portfolio"
							className="inline-flex items-center gap-2 rounded-sm border border-outline-variant px-8 py-3.5 text-[11px] font-medium tracking-[0.1em] text-on-surface uppercase transition-all hover:border-secondary hover:text-secondary"
						>
							View Portfolio
						</Link>
					</div>
					{suggestions.length > 0 && (
						<div className="mt-16">
							<p className="mb-6 text-[11px] font-medium tracking-[0.1em] text-on-surface-variant uppercase">
			...
			<div className="mx-auto max-w-md px-4 text-center">
				...
				<div className="mt-8 flex justify-center gap-4">
					<button
						type="button"
						onClick={() => reset()}
						className="rounded-sm bg-secondary px-6 py-3 text-[11px] font-medium tracking-[0.1em] text-on-secondary uppercase transition-all hover:opacity-90"
					>
						Try Again
					</button>
					<Link
						to="/"
						className="rounded-sm border border-outline-variant px-6 py-3 text-[11px] font-medium tracking-[0.1em] text-on-surface uppercase transition-all hover:border-secondary hover:text-secondary"
					>
						Go Home
					</Link>
				</div>
