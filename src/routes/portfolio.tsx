...
export const Route = createFileRoute('/portfolio')({
  ...
  head: () => ({
    meta: [
      ...
      {
        property: 'og:title',
        content: 'Our Portfolio — Shaon Landmarks & Housing',
      },
      {
          ...
          >
            {filters.map((f) => (
              <button
                ...
                className={`rounded-sm px-4 py-2 text-[11px] font-medium tracking-widest uppercase transition-colors ${
                  activeFilter === f
              ...
              >
                ...
                >
                  ...
                  <div className='absolute right-3 top-3'>
                    <span
                      className={`rounded-sm border px-2.5 py-1 text-[10px] font-medium tracking-widest uppercase ${statusColors[project.status]}`}
                    >
                      {project.status}
                    </span>
                  </div>
                  <div className='absolute bottom-0 left-0 right-0 p-6'>
                    ...
                    <motion.div
                      className='mt-3 flex items-center gap-1 text-[11px] font-medium tracking-widest text-secondary uppercase'
